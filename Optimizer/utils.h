...
extern vector<vector<int>> cameratoworld_store;
...
extern bool *camForOptimization;
extern bool *ptForOptimization;
extern vector<pair<int,string>>inv_mapping;
extern int num_observation_projection;
extern vector<int> isNewCam;
extern vector<float> focalinit;
