...
//#if !defined(WIN32) && !defined(__NO_MKL__) && 0
//#include "ippm.h"
...
//        int ldb = m;
//        int *jpvt = calloc(sizeof(int), n);
//        double rcond = oid matrix_transpose(int m, int n, double *A, double *AT) {
//                int i, j;
//                for (i = 0; i < m; i++)
//                    for (j = 0; j < n; j++)
//                        AT[j * m + i] = A[i * n + j];
...
//        /* Query to find a good size for the work array */
//        dgelsy_(&m, &noid matrix_transpose(int m, int n, double *A, double *AT) {
//                    int i, j;
//                    for (i = 0; i < m; i++)
//                        for (j = 0; j < n; j++)
//                            AT[j * m + i] = A[i * n + j];
